...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalUseAccess().getArgsAssignment_2_0(), "rule__ExternalUse__ArgsAssignment_2_0");
			builder.put(grammarAccess.getExternalUseAccess().getArgsAssignment_2_1_1(), "rule__ExternalUse__ArgsAssignment_2_1_1");
			...
			builder.put(grammarAccess.getParenthesesAccess().getExpAssignment_1(), "rule__Parentheses__ExpAssignment_1");
